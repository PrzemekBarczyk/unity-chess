...
namespace Backend
{
    public static class SimplifiedAlgebraicNotation
    {
        ...
        internal static Move LongSANToMove(ChessEngine chessEngine, string longAlgebraicNotation)
        {
        ...
        internal static Vector2Int ShortSANToPosition(string algebraicNotation)
        {
            byte fileIndex = 0;
        ...
        internal static string PositionToShortSAN(Vector2Int position)
        {
            int rankIndex = 0;
            foreach (char fileSymbol in "abcdefgh")
            {
